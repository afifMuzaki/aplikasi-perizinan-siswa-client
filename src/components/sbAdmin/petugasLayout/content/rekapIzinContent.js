                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning mx-2 text-white" type="button" data-bs-toggle="modal" data-bs-target="#modal-1">Detail</button>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot>
...
export default RekapIzinContentGuru;